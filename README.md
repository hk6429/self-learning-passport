...
妖界 2.0 首頁、三身份入口、七座學習主域、今日航線與完整自學站群已完成正式發布。

平台目錄以原「遊戲化自學入口」13 站為來源；本入口排除 1 個歷屆會考型平台後，學生與家長可探索 10 個自學平台，老師可使用全部 12 個非會考平台。七座主域包括字字珠璣、字鬥英雄、步學吾數、文豪笑傳、文言解憂站、科學英雄與凡人煉心訣。
