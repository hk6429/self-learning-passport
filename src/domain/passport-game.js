...
const RELICS = Object.freeze([
  Object.freeze({
    ...
    learningMeaning: "記錄你完成第一條真實航線，願意讓開始發生。",
  ...
  Object.freeze({
    ...
    learningMeaning: "記錄你在國語文航線留下理解、疑問或再練一次的證據。",
  ...
  Object.freeze({
    ...
    learningMeaning: "記錄你願意比較聲音、意思與情境，不只追答案。",
  ...
  Object.freeze({
    ...
    learningMeaning: "記錄你在數學卡關時調整方法、重新找出規律。",
  ...
  Object.freeze({
    ...
    learningMeaning: "記錄你曾提出問題、驗證想法，或保留值得再查的疑問。",
  ...
  Object.freeze({
    ...
    learningMeaning: "記錄你跨域探路、回望策略，逐漸長出自己的學習方法。",
